...
SUMMARY~~
1)if - Specific condition true ho toh code chalega.
2)else - Agar if false hai toh code chalega.
3)else if - Multiple conditions check karne ke liye.
4)Nested if - Conditions ke andar conditions.
5)switch - Multiple values check karne ka neat tariqa.
6)Ternary Operator - Short form for if-else.
